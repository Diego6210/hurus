...
<head>
    ...
    <title><?= $titulo ?></title>
    <link rel="shortcut icon" href="<?php echo site_url('app/core/assets/favicon.ico');
?>">
    <meta content="Tishca" name="description" />
    <meta content="TPX" name="author" />
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,900" rel="stylesheet">
    <link href="<?php echo site_url('app/core/assets/error/css/style.css');?>" rel="stylesheet" type="text/css">
</head>
<body>
